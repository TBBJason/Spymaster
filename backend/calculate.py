...
#         max_sim = -1
#         self.target_words_similarity = []  # Initialize as list of native floats
...
#                 # Store similarity as native float
#                 self.target_words_similarity = [self.model.similarity(word, target) for target in chosen_words]
